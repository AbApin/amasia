  ...
  mutations: {
    ...
    initialiseVars(state) {
      if (localStorage.getItem('xanutner')) {
        state.xanutner = JSON.parse(localStorage.categories);
        if (localStorage.getItem('locations')) state.locations = JSON.parse(localStorage.locations);
      }
    },
  },
  getters: {
