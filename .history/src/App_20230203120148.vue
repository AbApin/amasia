  ...
  <div id="app">
    <div class="header">
      <div class="avelacnelXanut">
        <input type="text" class="avelacnelInput" placeholder="Գրել խանութի անունը" v-model="inputValue"/>
        <button class="avelacnelBtn" @click="AVELACNEL_XANUT()">Ավելացնել</button>
      </div>
      <div class="cuycTal">
