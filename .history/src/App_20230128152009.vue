          ...
          <ul class="apranqneriList">
            ...
            >
              ...
              <div class="apranqiAvelPakas">
                <button class="plus apranqiBtn" @click="this.AVELACNEL({ xanutiAnun, apranqiHamar })">
                  +
                </button>
                <button class="minus apranqiBtn" @click="this.PAKASACNEL({ xanutiAnun, apranqiHamar })">
                  -
                </button>
              </div>
            </li>
...
export default {
  ...
  mounted() {},
  methods: {
    ...mapActions(['AVELACNEL', 'PAKASACNEL']),
    // avelacnel(obj) {
    //   this.AVELACNEL(obj);
    // },
    // pakasacnel(obj) {
