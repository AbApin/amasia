<template>
  <div id="app">
    <div class="header">
      ...
      <div class="cuycTal">
        <button class="cuycTalBtn">ցույց տալ ընդհանուրը</button>
          ...
          <ul class="endhanurQanakiList">
            ...
            >
              ...
              <ul class="endhanurApranqneriList">
                <li v-for="endhanurApranq in ZAKAZNER[xanutiAnun]" :key="endhanurApranq" class="endhanurApranqneriListItem">
                  <p class="endhanurApranqneriListItemAnun"></p>
                  <p class="endhanurApranqneriListItemQanak"></p>
                </li>
              </ul>
            </li>
          </ul>
