  ...
  <div id="app">
    <div class="header">
      ...
      <div class="cuycTal">
        ...
        <button class="heracnelBtn" @click="REMOVEXANUTNER">հեռացնել Խանութները</button>
        <button class="heracnelBtn" @click="REMOVEALL">հեռացնել քանակները</button>
      </div>
...
export default {
  ...
  methods: {
    ...
    avelacnelXanut() {
      this.AVELACNEL_XANUT(this.inputValue);
      this.inputValue = '';
    },
  },
  computed: {
  ...
  watch: {
    isClick(newVal) {
      console.log(newVal);
      newVal ? (document.body.style.overflow = 'hidden') : (document.body.style.overflow = 'hidden');
    },
  },
};
</script>
