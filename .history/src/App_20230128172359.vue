...
export default {
  ...
  mounted() {
    console.log(this.ZAKAZNER);
  },
  methods: {
    ...mapMutations(['AVELACNEL', 'PAKASACNEL']),
  },
  computed: {
    ...mapGetters(['XANUTNER', 'ZAKAZNER']),
  },
};
</script>
...
.endhanurQanakiListItem {
  display: flex;
  align-items: center;
  flex: 1 1 0;
  border-bottom: 1px solid #000;
}
.endhanurQanakiListItem:last-child {
  border-bottom: none;
}
.endhanurQanakiListItemXanutiAnun {
  border-right: 1px solid #000;
  width: 10%;
  display: flex;
  align-items: center;
...
.endhanurApranqneriListItem:last-child{
  border-bottom: none
}
.endhanurApranqneriListItemQanak {
  color: red;
  font-size: 25px;
  font-family: 'Inter';
  font-weight: 700;
}
.endhanurApranqneriListItemAnun {
  font-weight: bold;
  font-size: 20px;
}
.closeBtn {
